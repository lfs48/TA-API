export const ABILITY_SEED_DATA = [
    {
        ...
        data: {
            ...
            <p>
                ...
                said initially. Roll <b>Presence.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> the target believes that the new sentence
                is what they meant.
            </p>
            `,
            additional:`
            <p>
                <b>On six or more 3s,</b> you may speak for the target at any time in the next hour.
            </p>
            `,
            failure:`
            <p>
                <b>On a failure,</b> the target is unaffected, and for the next 3 hours
    ...
    },
    {
        ...
        data: {
            ...
            <p>
                ...
                Let their words reach your voice and roll <b>Empathy.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> you say what the target wishes they were
                saying right now.
            </p>
            `,
            additional:`
            <p>
                <b>On every third 3,</b> you may ask a question about something
            ...
            failure:`
            <p>
                <b>On a failure,</b> you admit something you don't want anyone to know.
            </p>
            `,
            question:`
    ...
    },
    {
        ...
        data: {
            ...
            <p>
                ...
                to cancel out the noises you make. Roll <b>Subtlety.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> none of your actions make a sound until after
                you make another roll or close your mouth.
            </p>
            `,
            additional:`
            <p>
                <b>For each additional 3,</b> you can silence the actions of one
                additional target until this effect ends.
            </p>
            `,
            failure:`
            <p>
                <b>On a failure,</b> your frequency becomes imbalanced and you
    ...
    },
    {
        ...
        data: {
            description: `
            <p>
                Point somewhere nearby and say "what's that over there?" Roll <b>Attentiveness.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> you create an object where you're pointing. It can be any mundane
            ...
            additional:`
            <p>
                <b>For each additional 3,</b> you may add another object nearby.
            </p>
            `,
            failure:`
            <p>
                <b>On a failure,</b> the GM will describe a different object that is now there, and it is either obviously
    ...
    },
    {
        ...
        data: {
            description: `
            <p>
                Hold any object small enough to carry and roll <b>Dynamism.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> the object changes to a similar but different version
            ...
            additional:`
            <p>
                <b>On every third 3,</b> you may give the object an
            ...
            failure:`
            <p>
                <b>On a failure,</b> the object is replaced with
    ...
    },
    {
        ...
        data: {
            description: `
            <p>
                Open a container large enough to fit you entirely inside. Roll <b>Duplicity.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> an alternate version of you is inside. They have one
            ...
            additional:`
            <p>
                <b>On six or more 3s,</b> you can create an additional alternate self.
            </p>
            `,
            failure:`
            <p>
                <b>On a failure,</b> the alternate version you reveal
    ...
    },
    {
        ...
        data: {
            ...
            <p>
                ...
                "Would you like some more?" and roll <b>Empathy.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> the person you are speaking to becomes very interested in more of the
            ...
            additional:`
            <p>
                <b>For each additional 3,</b> you may spread their
                desire to one other nearby target to similar effect.
            </p>
            `,
            failure:`
            <p>
                <b>On a failure,</b> the target develops a loathing for
    ...
    },
    {
        ...
        data: {
            ...
            <p>
                ...
                voice, their love, their fingerprints—now you have it, and they do not. Roll <b>Duplicity.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> select a nearby living person
            ...
            additional:`
            <p>
                <b>For each additional 3,</b> choose one:
            </p>
            <ul>
                <li>The target keeps a flawed version of what's borrowed.</li>
                <li>The effect lasts an additional hour.</li>
                <li>You may share what's borrowed with one other target.</li>
            </ul>
            `,
            failure:`
            <p>
                <b>On a failure,</b> the target loses what you've
    ...
    },
    {
        ...
        data: {
            description: `
            <p>
                When you receive Harm or are hurt in any way, you may roll <b>Persistence.</b>
            </p>
            `,
            success:`
            <p>
            ...
            additional:`
            <p>
                <b>For each additional 3,</b> you may choose an additional target
                who receives that same hurt.
            </p>
            `,
            failure:`
            <p>
                <b>On a failure,</b> your pain cycles back on itself,
    ...
    },
    {
        ...
        data: {
            ...
            <p>
                ...
                check any clock and say the phrase "We've got time." Roll <b>Professionalism.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> you're right. If the task is focused on and approached
                genuinely, it will be completed before the impending deadline.
            </p>
            `,
            additional:`
            <p>
                <b>For each additional 3,</b> you gain an
            ...
            failure:`
            <p>
                <b>On a failure,</b> you are catastrophically, terribly
    ...
    },
    {
        ...
        data: {
            ...
            <p>
                ...
                the result, punch a clock and roll <b>Initiative.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> you send the target back in time to assist themselves, allowing them
            ...
            additional:`
            <p>
                <b>For each additional 3,</b> you add one 3 to the second use.
                This effect can make a roll exceed six 3s.
            </p>
            `,
            failure:`
            <p>
                <b>On a failure,</b> the original roll becomes a
    ...
    },
    {
        ...
        data: {
            ...
            <p>
                ...
                slip away. Hum a tune and roll <b>Empathy.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> all past events, even recent
            ...
            additional:`
            <p>
                <b>On every third 3,</b> you may request
            ...
            failure:`
            <p>
                <b>On a failure,</b> the target becomes
    ...
    },
    {
        ...
        data: {
            ...
            <p>
                ...
                "I'll cover you!" and extend your flesh to protect them. Roll <b>Persistence.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> you grow rapidly around them and take the attack
    ...
    },
    {
        ...
        data: {
            ...
            <p>
                ...
                already possess. Roll <b>Dynamism.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> you gain reach and
            ...
            <ul>
                <li>Disarm a target.</li>
                <li>Engage one more target.</li>
                <li>Render an engaged target unconscious.</li>
                <li>Kill an unconscious target.</li>
            </ul>
            `,
            failure:`
            <p>
                <b>On a failure,</b> you become only
    ...
    },
    {
        ...
        data: {
            description: `
            <p>
                Open a few more eyes. Roll <b>Professionalism.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> you sprout new eyes on your body, with potent new abilities.
            </p>
            `,
            additional:`
            <p>
            ...
            <ul>
                <li><b>1:</b> Heat, Night, or Telescopic</li>
                <li><b>2:</b> Fingerprint or X-Ray</li>
                <li><b>3:</b> Reality (Cuts through illusions and obfuscations)</li>
                <li><b>4:</b> Plant Sign Language, Anomaly Tracking</li>
                <li><b>6:</b> Weakness</li>
                <li><b>7:</b> Future Sight</li>
            </ul>
            `,
            failure:`
            <p>
                <b>On a failure,</b> you see A Vision of the End. You
    ...
    },
    {
        ...
        data: {
            ...
            <p>
                ...
                Once, they existed. Now they do not. Aim your Gun and roll <b>Dynamism.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> the target disappears without a trace.
            </p>
            `,
            additional:`
            <p>
                <b>On six or more 3s,</b> choose any number
            ...
            failure:`
            <p>
                <b>On a failure,</b> the target is killed. An object is
    ...
    },
    {
        ...
        data: {
            description: `
            <p>
                When something tries to hurt you, fire your Gun and roll <b>Initiative.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> you shot first. The aggressor
            ...
            additional:`
            <p>
                <b>For each additional 3,</b> you may choose an
            ...
            failure:`
            <p>
                <b>On a failure,</b> you misfire. Something or someone
    ...
    },
    {
        ...
        data: {
            ...
            <p>
                ...
                sense it. Make your options clear and roll <b>Presence.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> a target you are focusing on is intimidated enough to do what you want.
                However, the GM chooses one consequence from the following. The target will:
            </p>
            <ul>
                <li>Remember your face.</li>
                <li>Contact the authorities.</li>
                <li>React with extreme fear.</li>
                <li>Seek retribution.</li>
            </ul>
            `,
            additional:`
            <p>
                <b>For each additional 3,</b> you may either remove
            ...
            failure:`
            <p>
                <b>On a failure,</b> the target is unafraid. They become
    ...
    },
    {
        ...
        data: {
            ...
            <p>
                ...
                and wrap its shadow around yourself. Roll <b>Presence.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> you may adopt an illusory form and appear as that form to your target.
                The form can be terrifying, beautiful, or mundane—and they believe it's your true form.
            </p>
            `,
            additional:`
            <p>
                <b>On every third 3,</b> you may ask the player controlling the target
                to tell you one of the following before you take this form:
            </p>
            <ul>
                <li>Their worst fear.</li>
                <li>Their greatest goal.</li>
                <li>Their most secret desire.</li>
            </ul>
            `,
            failure:`
            <p>
                <b>On a failure,</b> your true identity is emblazoned
    ...
    },
    {
        ...
        data: {
            description: `
            <p>
                Blow a pinch of sand onto a target and roll <b>Subtlety.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> you send the target into a sudden sleep.
            ...
            additional:`
            <p>
                <b>On every third 3,</b> choose one:
            </p>
            <ul>
                <li>Add an additional target to this effect.</li>
                <li>The effect lasts an additional hour.</li>
            </ul>
            `,
            failure:`
            <p>
                <b>On a failure,</b> another target, an ally or
    ...
    },
    {
        ...
        data: {
            ...
            <p>
                ...
                video, novel, or other piece of art and roll <b>Attentiveness.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> you and any nearby allies you choose enter the world depicted. While
            ...
            <ul>
                <li>You and your allies change appearance to fit in with the art.</li>
                <li>When you leave, this piece of art is returned to its original condition.</li>
            </ul>
            `,
            failure:`
            <p>
                <b>On a failure,</b> you forget how to hide your tracks.
    ...
    },
    {
        ...
        data: {
            ...
            <p>
                ...
                and then describe a short path to the discussed location. Roll <b>Initiative.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> your directions are correct,
            ...
            additional:`
            <p>
                <b>For each additional 3,</b> an additional person
                may use your shortcut before it disappears.
            </p>
            `,
            failure:`
            <p>
                <b>On a failure,</b> your shortcut leads
    ...
    },
    {
        ...
        data: {
            ...
            <p>
                ...
                in a maze or endless hallway. Tie a knot and roll <b>Persistence.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> you trap them in a complex, repeating path of
                your own design. They cannot exit until you make another roll.
            </p>
            `,
            additional:`
            <p>
                <b>For each additional 3,</b> you may trap
            ...
            failure:`
            <p>
                <b>On a failure,</b> you speed them
    ...
    },
    {
        ...
        data: {
            description: `
            <p>
                Adjust your balance and roll <b>Professionalism.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> you change the orientation of gravity up to 90 degrees in a direction
            ...
            <ul>
                <li>The change doesn't affect a single target, such as yourself.</li>
                <li>The range is infinite for a single target.</li>
                <li>Gravity for a single target is rotated further than 90 degrees.</li>
            </ul>
            `,
            failure:`
            <p>
                <b>On a failure,</b> you become unmoored from
    ...
    },
    {
        ...
        data: {
            ...
            <p>
                ...
                touch or hurt you, you can say "Missed!" and roll <b>Duplicity.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> you were always
            ...
            additional:`
            <p>
                <b>For each additional 3,</b> another willing,
            ...
            failure:`
            <p>
                <b>On a failure,</b> the target moves instead — to
    ...
    },
    {
        ...
        data: {
            description: `
            <p>
                Inspect the place where something once was. Roll <b>Attentiveness.</b>
            </p>
            `,
            success:`
            <p>
                <b>On a success,</b> you can see the lost history
            ...
            additional:`
            <p>
                <b>On every third 3,</b> you may say one sentence
                about what is lost, and that sentence is true.
            </p>
            `,
            failure:`
            <p>
                <b>On a failure,</b> there's too much loss. You
    ...
    },
    {
        ...
        data: {
            ...
            success:`
            <p>
                <b>On a success,</b> you pass directly through it. You become intangible and can
            ...
            failure:`
            <p>
                <b>On a failure,</b> you lose control of your physical
